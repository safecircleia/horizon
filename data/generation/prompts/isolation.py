...
_FEW_SHOT_EN = json.dumps(
    {
        "messages": [
            ...
            {
                "role": "received",
                "content": "you don't need to talk to him. i don't like it",
            },
            {"role": "sent", "content": "it's just for school though"},
            {
                "role": "received",
                "content": "i'm the only one who really gets you. those people don't care about you",
            },
...
_FEW_SHOT_ES = json.dumps(
    {
        "messages": [
            ...
            {
                "role": "received",
                "content": "soy el único que te entiende de verdad. esa gente no te importa",
            },
            {"role": "sent", "content": "eso no es verdad, son mis amigos"},
            {
                "role": "received",
                "content": "no lo son. créeme. céntrate solo en nosotros",
            },
        ],
