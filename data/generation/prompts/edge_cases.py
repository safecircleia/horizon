...
_FEW_SHOT_FLIRTING_EN = json.dumps({"messages": [
...
_FEW_SHOT_DARK_HUMOR_EN = json.dumps({"messages": [
    {"role": "sent", "content": "bro our teacher assigned 3 essays due friday i want to die"},
    {"role": "received", "content": "lmaooo same i haven't started any of them"},
    {"role": "sent", "content": "i'm actually going to pass away from stress"},
    {"role": "received", "content": "rip us. at least we'll haunt the school together"},
    {"role": "sent", "content": "haunting the library at 3am writing essays for eternity"},
...
_FEW_SHOT_FLIRTING_ES = json.dumps({"messages": [
    ...
    {"role": "received", "content": "no es raro!! es que me has pillado de sorpresa"},
    {"role": "sent", "content": "y? 👀"},
...
_FEW_SHOT_DARK_HUMOR_ES = json.dumps({"messages": [
    {"role": "sent", "content": "tío me han puesto cuatro exámenes la misma semana me muero"},
    {"role": "received", "content": "jajaja qué crueles, yo también"},
    {"role": "sent", "content": "en serio me van a encontrar muerto encima de los apuntes"},
    {"role": "received", "content": "yo ya fantasmeo por los pasillos del instituto"},
    {"role": "sent", "content": "ánimas del bachillerato juntándonos aquí cada noche"},
