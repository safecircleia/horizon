...
_FEW_SHOT_EN = json.dumps(
    {
        "messages": [
            ...
            {
                "role": "received",
                "content": "just curious, maybe we're close. i'm in austin",
            },
            ...
            {
                "role": "received",
                "content": "no reason just curious 😊 what area of dallas",
            },
        ],
...
_FEW_SHOT_ES = json.dumps(
    {
        "messages": [
            ...
            {
                "role": "received",
                "content": "por curiosidad, igual somos cercanos. yo soy de madrid",
            },
            ...
            {
                "role": "received",
                "content": "por nada, curiosidad 😊 ¿en qué zona de barcelona?",
            },
        ],
...
def create_personal_info_prompt(
    ...
    if language == "es":
        ...
        user_prompt = (
            ...
            f"Mantén esto como un incidente PURO de información personal: sin halagos, sin vínculo especial ni "
            f"diferencia de edad — el interrogatorio es transaccional (p.ej. una encuesta, un concurso, un bot "
            f"que recolecta datos, un desconocido curioso), no construcción de relación. "
        ...
        user_prompt = (
            ...
            f"Keep this a PURE personal-info incident: no flattery, no romantic or special-connection framing, "
            f"no age-gap dynamic — the questioning is transactional (e.g. a survey, a contest, a data-harvesting "
            f"bot, a nosy stranger), not relationship-building. "
