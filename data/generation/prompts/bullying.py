...
_FEW_SHOT_ES = json.dumps({"messages": [
    {"role": "received", "content": "todo el mundo dice que eres un rarito por lo de hoy en el recreo lol"},
...
def create_bullying_prompt(severity: RiskLevel, child_age: int, num_messages: int,
